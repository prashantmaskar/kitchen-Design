 ...
 <div class="section section_padding custome_dsection">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                 <div class="section-title">
                        <h2> Cutomization In smarteco</h2>
                    </div>
            </div>
            <!-- Page Content -->
...
<div class="section book_visitform">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
  ...
  <div class="col-md-2">            
    <div class="form-group">
    <div class="controls">
    <input type="text" placeholder="Mobile" name="contact">
    </div>
    </div>
</div>
  <div class="col-md-2">            
...
<div class="col-md-2">
    <button type="submit" id="submit" class="btn-system btn-large">Book Visit</button>
    </div>
</form>
        </div>
        </div>
