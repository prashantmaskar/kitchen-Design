                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <ul class="contact-details hidden-xs">
                                    <li><a href="#"><i class="fa fa-map-marker"></i> Kitchen Mania, Wagholi, Pune</a>
                                    </li>
                                    <li><a href="#"><i class="fa fa-envelope"></i> info@kitchen.in</a>
                                    </li>
                                    <li><a href="#"><i class="fa fa-phone"></i> 08852800466 </a>
                                    </li>
                                </ul>
                                <!-- End Contact Info -->
                            </div><!-- .col-md-6 -->
            ...
            <footer>
                <div class="container">
                    <div class="row footer-widgets">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget mail-subscribe-widget">
                                ...
                                <p><i class="fa fa-envelope"></i> <a href="mailto:Info@aspartners.com">Info@Kitchen Mania.com</a></p>
                            </div>
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget twitter-widget">
                                ...
                                <ul>
                                    <li>
                                        <p><a href="#">@Kitchen Mania </a> Kitchen Mania work with certified and expert people for you.</p>
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget contact-widget">
                                <h4>Kitchen Mania</h4>
                                <p>KitchenMania has delivered Modern Kitchen solution, our aim to provide beautiful and durable kitchen services.<p>
                                <ul>
                                    <li><span>Phone Number:</span> 08004668446 </li>
                                    <li><span>Email:</span> info@KitchenMania.in</li>
                                    <li><span>Website:</span> www.KitchenMania.in</li>
                                </ul>
                            </div>
                        </div><!-- .col-md-3 -->
                        <!-- End Contact Widget -->
                    ...
                    <div class="copyright-section">
                        <div class="row">
                            <div class="col-md-6">
                                <p>&copy; 2017 Kitchen Mania-  All Rights Reserved <a href="#">Kitchen Mania</a> </p>
                            </div><!-- .col-md-6 -->
                            <div class="col-md-6 ">
